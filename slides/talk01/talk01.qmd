...
> AI使用：可用AI辅助数据分析和报告撰写，但须在报告中说明使用了哪些AI工具，它们在分析中的具体作用。评分时会考虑AI使用的合理性和对分析结果的贡献。
...
::: {.column width="60%"}
<span style="font-family: 'Georgia', 'Times New Roman', serif; font-size: 4.5rem;">
...
::: {.r-stack}
![](images/R_GUI.png){.fragment height=500px}
:::
